...
const index = () => {
  ...
  return (
    <div>
            ...
            <div className="flex flex-col justify-center items-center min-h-screen bg-gray-100">
              <div className="bg-white rounded-lg shadow-lg overflow-hidden flex items-center justify-center flex-row w-full h-full max-w-5xl">
                ...
                <div className="p-20">
                  ...
                  {
                    isLoggedIn ? (
                      <div className="flex items-center mt-4 gap-1 rounded bg-gray-200">
                        <textarea
                          type="text"
                          className="bg-gray-200 focus:h-24 transition-all ring-0 outline-none focus:ring-0 border-none focus:transition-all resize-none grow h-11 w-full px-4 py-2 rounded focus:outline-none "
                          placeholder="Add a comment"
                          value={commentValue}
                          onChange={e => setCommentValue(e.target.value)}
                        />
                        <button
                          className="bg-gray-200 h-11 px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                          type="submit"
                      ...
                      <div className="mt-4">
                        <input
                          type="text"
                          className="bg-gray-200 w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      {
        isShowingComments ? (
          <CommentsBox handleExit={handleExitComments} apiData={commentsApiData} />
        ) : (
          <div></div>
        )
      }
